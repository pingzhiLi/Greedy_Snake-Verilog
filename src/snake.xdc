...
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { pulse }]; #IO_L24N_T3_RS0_15 Sch=sw[0]
...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets BTN[4]];
...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets pulse];
